...
def main():
    ...
    parser.add_argument("--vicuna_model", type=str, default="lmsys/vicuna-13b-v1.3", help="Vicuna model for prediction")
    parser.add_argument("--bert_model", type=str, default="bert-base-uncased", help="BERT model for regression")
